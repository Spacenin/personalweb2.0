        ...
        <div className="flex flex-col">
            <div className="flex flex-row">
                ...
                <div className="flex flex-col m-8">
                    <div className="flex flex-row w-full">
                        <h1 className="flex px-4 py-1 align-bottom font-bold text-md sm:text-2xl bg-custom-folder rounded-t-lg">About Me</h1>
                    </div>
                    <p className="flex bg-custom-folder text-sm sm:text-lg font-medium rounded-tr rounded-bl rounded-br p-5 h-full">
            ...
            <div className="flex flex-row">
                <div className="flex flex-col m-8 w-1/2">
                    <div className="flex flex-row w-full">
                        <h1 className="flex px-4 py-1 align-bottom font-bold text-md sm:text-2xl bg-custom-folder rounded-t-lg">Education</h1>
                    </div>
                    <p className="flex bg-custom-folder text-sm sm:text-lg font-medium rounded-tr rounded-bl rounded-br p-5 h-full">
                        <ul>
                            <li><img className="h-5 m-2 inline" src={process.env.PUBLIC_URL + "/file.png"}></img>item</li>
                        </ul> 
                    </p>
                </div>
                <div className="flex flex-col m-8 w-1/2">
                    <div className="flex flex-row w-full">
                        <h1 className="flex px-4 py-1 align-bottom font-bold text-md sm:text-2xl bg-custom-folder rounded-t-lg">Experience</h1>
                    </div>
                    <p className="flex bg-custom-folder text-sm sm:text-lg font-medium rounded-tr rounded-bl rounded-br p-5 h-full">
            ...
            <div className="flex flex-row">
                <div className="flex flex-col m-8 w-2/3">
                    <div className="flex flex-row w-full">
                        <h1 className="flex px-4 py-1 align-bottom font-bold text-md sm:text-2xl bg-custom-folder rounded-t-lg">Personal Projects</h1>
                    </div>
                    <p className="flex bg-custom-folder text-sm sm:text-lg font-medium rounded-tr rounded-bl rounded-br p-5 h-full">
